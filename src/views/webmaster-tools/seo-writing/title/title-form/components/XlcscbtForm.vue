    ...
    <div>
      <a-grid :col-gap="20" :row-gap="10">
        ...
        <a-grid-item :span="12">
          <div class="flex_box form_item form_item_radio">
            <div class="form_title"><span style="color: #ff0000">*</span>下拉来源</div>
      ...
      <a-grid :col-gap="20" :row-gap="10">
        ...
        <a-grid-item :span="12" v-if="(XlTitleForm.style === 1 && XlTitleForm.rule === 2) || XlTitleForm.style === 2">
          <div class="flex_box form_item form_item_radio">
            <div class="form_title"><span style="color: #ff0000">*</span>下拉选词</div>
        ...
        <a-grid-item :span="12" v-if="XlTitleForm.style === 2">
          <div class="flex_box form_item form_item_radio">
            <div class="form_title"><span style="color: #ff0000">*</span>下拉组合</div>
        ...
        <a-grid-item :span="12" v-if="(XlTitleForm.style === 1 && XlTitleForm.rule === 2) || XlTitleForm.style === 2">
          <div class="flex_box form_item form_item_radio">
            <div class="form_title"><span style="color: #ff0000">*</span>下拉词长度</div>
        ...
        <a-grid-item :span="12" v-if="XlTitleForm.style === 2">
          <div class="flex_box form_item form_item_radio">
            <div class="form_title"><span style="color: #ff0000">*</span>标题总长度</div>
        ...
        <a-grid :col-gap="20" :row-gap="10" class="form_content">
          <a-grid-item :span="12" class="flex_box form_content_item">
            <div class="form_content_input">
              <a-textarea v-model="XlTitleForm.includeKeyword" class="form_area" placeholder="请输入关键词，每行一个关键词" allow-clear />
            </div>
          </a-grid-item>
          <a-grid-item :span="12" class="form_content_item">
            <div class="form_content_input">
              <a-textarea v-model="XlTitleForm.excludeKeyword" class="form_area" placeholder="请输入关键词，每行一个关键词" allow-clear />
            </div>
          </a-grid-item>
        </a-grid>
      </div>
