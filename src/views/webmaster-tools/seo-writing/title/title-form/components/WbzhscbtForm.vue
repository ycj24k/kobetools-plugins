      ...
      <a-grid-item :span="18" class="form_left">
        ...
        <div class="form_item">
          <div class="flex_box flex_row_between">
            <div class="form_title" style="width: 400px;"><span style="color: #ff0000">*</span>组合方式</div>
        ...
        <div class="form_item">
          ...
          <a-grid :col-gap="20" :row-gap="10">
            ...
            <a-grid-item :span="10" class="flex_box">
              <div class="form_label form_label1">{{ localeGet('label4') }}</div>
        ...
        <div class="flex_box flex_row_between form_btn">
          ...
          <a-button class="form_btn6" type="primary" :loading="loading" @click="copyKeywords">复制所有标题</a-button>
        </div>
      </a-grid-item>
...
import { orderingFormDefault, lengthMinOptions, lengthMaxOptions, customOptions, orderOptions } from '../../utils/config';
