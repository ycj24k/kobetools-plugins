export default {
  ...
  value: {
    ...
    'zh-TW': [
      '詞庫查詢', '詞庫查詢', '請輸入需要查詢的網站域名，一行一個，單詞最多提交10個，格式如：www.google.com', '立即查詢', '導出查詢结果', 'VIP查詢通道', '全选', '反选', '清除', '請選擇搜索引擎！', '請輸入需要查詢的網站域名！', '未获取到查詢结果', '搜索引擎', '工具介紹：', '1、Kobetools網站詞庫查詢工具支持批量查詢網站在愛站、站長工具的關鍵詞詞庫數據。', '2、Kobetools網站詞庫查詢工具可以快速分析競爭對手站點的關鍵詞布局和SEO策略。', '序號', '網站域名', '百度', '谷歌', '必應', '360', '搜狗', '神馬', '頭條', '雅虎', 'Yandex'
    ],
  },
};
