export default {
  field: [
    'pageName', 'type1', 'type2', 'placeholder1', 'button1', 'button2', 'button3', 'message1', 'message2', 'message3', 'introduce1', 'content1', 'content2', 'columns.label1', 'columns.label2', 'columns.label3'
  ],
  value: {
    'en-US': [
    ...
    'zh-TW': [
      'IP/網站查詢', 'IP/網站查詢', 'IP/網站查詢详情', '請輸入需要查詢的域名或IP地址，一行一個，單次最多提交20個', '立即查詢', '導出查詢结果', 'VIP查詢通道', '請輸入需要查詢的域名或IP地址！', '請選擇需要導出的數據', '請選擇需要查詢的域名！', '工具介紹：', '1、Kobetools IP/網站查詢工具支持批量查詢域名的IP地址和同IP網站信息。', '2、Kobetools IP/網站查詢工具可以幫助分析服務器上的網站數量和質量。', '序號', '域名/IP', '操作'
    ],
  },
};
