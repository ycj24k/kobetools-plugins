export default {
  field: [
    'pageName', 'type1', 'type2', 'placeholder1', 'button1', 'button2', 'button3', 'message1', 'message2', 'introduce1', 'content1', 'content2', 'columns.label1', 'columns.label2', 'columns.label3'
  ],
  value: {
    'en-US': [
    ...
    'zh-TW': [
      '外鏈查詢', '外鏈查詢', '外鏈查詢详情', '請輸入需要查詢的域名，一行一個，單次最多提交20個，格式如：google.com', '立即查詢', '導出查詢结果', 'VIP查詢通道', '請輸入需要查詢的域名！', '請選擇需要查詢的域名！', '工具介紹：', '1、Kobetools外鏈查詢工具支持批量查詢網站的外鏈數據。', '2、Kobetools外鏈查詢工具可以幫助分析網站的外鏈質量和分布情況。', '序號', '域名', '操作'
    ],
  },
};
