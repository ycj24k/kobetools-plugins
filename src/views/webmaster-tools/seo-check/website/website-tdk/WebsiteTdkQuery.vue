...
watch(() => props.locales, (newVal) => {
    ...
    columns.value = [
        { title: localeGet('columns.label1'), dataIndex: 'serialNumber', sortable: { sortDirections: ['ascend', 'descend'] }, width: 100 },
        { title: localeGet('columns.label2'), dataIndex: 'domain', sortable: { sortDirections: ['ascend', 'descend'] }, width: 150 },
        { title: localeGet('columns.label3'), dataIndex: 'title', width: 200 },
        { title: localeGet('columns.label4'), dataIndex: 'keywords', sortable: { sortDirections: ['ascend', 'descend'] }, width: 150 },
        { title: localeGet('columns.label5'), dataIndex: 'description', width: 200 },
    ];
}, { immediate: true });
